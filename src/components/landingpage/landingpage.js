    ...
    <Headroom>
      <header className="header">
        <a href="#" className="logo">
          ...
          <span className="logo-name">Questionsoverflow</span>
          <span className="grey-color"></span>
        </a>
          ...
          <div className="greeting-text-div">
            <div>
              <h1 className="greeting-text" id="type">
                ...
                <span>Welcome to Questionsoverflow</span>

                {" "}

              </h1>
              <p className="greeting-text-p subTitle">Share your questions and get clarified by fellow developers</p>
    ...
    <Fade bottom duration={1000} distance="5px">
      <div className="footer-div">
        <p className="footer-text">
          {emoji("Made with ❤️ by Saikiran Chatlapalli")}
        </p>
      </div>
    </Fade>
