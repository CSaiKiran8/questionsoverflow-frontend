...
function Vote({ questionid, id, votes, unvotes }) {
  ...
  const submitVote = async () => {
    ...
    const result = axios.post("https://questions-overflow.herokuapp.com/question/vote", data,
      {
        headers: {
  ...
  const submitUnvote = async () => {
    ...
    const result = axios.post("https://questions-overflow.herokuapp.com/question/unvote", data,
      {
        headers: {
          "Content-Type": "application/json",
          'authorization': token,
